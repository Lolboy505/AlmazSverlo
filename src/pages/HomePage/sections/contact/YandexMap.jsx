...
const YandexMap = () => {
    ...
    useEffect(() => {
        if (mapContainerRef.current && mapContainerRef.current.children.length === 0) {
            ...
            script.async = true;
            script.src = "https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Ad43f149a46431da9f7aab8ef186632d0048fcdb56f9acd5a379f916ac75eef7e&width=100%&height=400&lang=ru_RU&scroll=true";
    ...
    return (
        <div className="position-relative overflow-hidden rounded shadow-lg map-dark-container"
            style={{ minHeight: '400px', background: '#121212' }}>
            ...
            {!isLoaded && (
                <div className="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column align-items-center justify-content-center bg-dark z-3">
                    ...
                    <p className="text-secondary small text-uppercase fw-bold tracking-wider">Грузим карту...</p>
                </div>
            )}
