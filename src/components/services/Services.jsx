...
const services = [
  {
    ...
    description: 'Подготовка технологических отверстий для приточно-вытяжной вентиляции и систем дымоудаления.',
  },
  {
    icon: Droplet,
    title: 'Водоснабжение и канализация',
    description: 'Бурение проходов для монтажа магистралей водопровода, септиков и узлов водоотведения.',
  },
  {
    icon: Wind,
    title: 'Климатическое оборудование',
    description: 'Высокоточное алмазное бурение под трассы кондиционеров и установку систем КИВ/рекуператоров.',
  },
  {
    icon: Zap,
  ...
  },
  {
    ...
    description: 'Работа с высокоармированным бетоном и камнем. Возможность бурения короноками до 400 мм.',
  },
  {
    icon: Settings,
